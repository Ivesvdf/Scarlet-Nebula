	...
	class ServerListMouseListener implements MouseListener
	{
		...
		public void mousePressed(MouseEvent e)
		{
			if (e.isPopupTrigger())
			{
				...
				final Server selectedServer = serverListModel.getVisibleServerAtIndex(indexOfSelectedServer);
				...
				JMenuItem pauseResume = new JMenuItem((status == ServerState.PAUSED) ? "Resume" : "Pause");
