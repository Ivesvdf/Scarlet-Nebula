...
public class ServerListMouseListener implements MouseListener {
	...
	private void showPopup(final MouseEvent e) {
		...
		final Collection<Server> allSelectedServers = list.getSelectedServers();
		...
		final Collection<Server> selectedServers = list.getSelectedServers();

		final VmState status = clickedServer.getStatus();

		final JPopupMenu popup = new JPopupMenu();
		final JMenuItem pause = new JMenuItem("Pause", Utils.icon("paused.png"));
